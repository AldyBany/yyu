...
const Emergency = () => {
  return (
    ...
    <div className="h-full bg-orange p-7">
      <h4 className="text-2xl text-blue font-semibold mb-3">Promotion Vidange !</h4>
        <p className="text-center mb-10 md:text-left text-white mt-6">Royal Car Service, les experts automobiles. C’est la bonne adresse pour une qualité de service exceptionnelle pour votre voiture. <span className="text-orange-600 font-semibold">064839857</span></p>
    ...
    <div className="px-4 py-6 h-80 -order-1 md:order-1 bg-orange relative" >
      <div className="">
      <Image  width={400} height={300} src="/total4.png" alt="total" className='w-96'/>
      </div>
